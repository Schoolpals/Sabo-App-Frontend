...
const SwitchDevice = () => {
    return (
        <div className="inset-0 fixed z-[999999999] flex-col justify-center items-center bg-[#030F3A] hidden md:flex">
            <figure className='min-h-[340px]'><motion.img initial={{ opacity: 0 }} animate={{ opacity: 1, scale: 1, y: 0, transition: { duration: 0.4, delay: 1 } }} className="w-full max-w-[550px] mb-[57px] outfit" src="/assets/images/404.svg" /></figure>
